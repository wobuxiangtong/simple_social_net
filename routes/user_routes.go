...
func UserLogin(ctx iris.Context) {
	...
	db.QueryRow("SELECT COUNT(id) AS userCount, id, username, password FROM users WHERE username=? group by id, username, password", rusername).Scan(&userCount, &id, &username, &password)
